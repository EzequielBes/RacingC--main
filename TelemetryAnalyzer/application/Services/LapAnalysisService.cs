...
namespace TelemetryAnalyzer.Application.Services
{
    public class LapAnalysisService
    {
        ...
        public async Task<TelemetryAnalyzer.Core.Models.LapAnalysis.LapData> CreateLapDataAsync(List<TelemetryData> telemetryPoints)
        {
            if (!telemetryPoints.Any()) return new TelemetryAnalyzer.Core.Models.LapAnalysis.LapData();

            var lapData = new TelemetryAnalyzer.Core.Models.LapAnalysis.LapData
            {
